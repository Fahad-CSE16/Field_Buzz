...
class SubmitForm(forms.Form):
    ...
    cgpa =forms.FloatField(max_value=4,min_value=2,required=True)
    experience_in_months = forms.IntegerField(max_value=100, min_value=0,required=True)
    current_work_place_name = forms.CharField(max_length=256,required=True)
